...
| 版本 | 发布日期 | 主要特性 |
|------|----------|----------|
| **v2.0.0** | 2025-01-10 | LeafCard 升级为 LeafBoss 业务运营支撑系统 |
| **v1.0.0** | 2024-10-27 | LeafCard 轻羽卡管系统正式上线 |
...
- **项目构思** (2024年1月) - 基于对现有卡管理系统的分析，构思开发一个轻量级、易用的卡管系统
- **技术选型** (2024年2月) - 确定使用Vue 3 + Spring Boot 3的技术栈，开始系统架构设计
- **核心开发** (2024年3月-7月) - 完成前后端核心功能开发，包括卡管理、用户管理、权限控制等
- **正式发布** (2024年10月27日) - LeafCard轻羽卡管系统正式上线，为用户提供服务
- **系统升级** (2025年1月10日) - LeafCard升级为LeafBoss业务运营支撑系统，支撑全面的系统
