              ...
              <div class="stat-item">
                ...
                <div class="stat-content">
                  ...
                  <div class="stat-trend">
                    <span class="trend-text">上月</span>
                    <span class="trend-value">¥{{ formatCurrency(stats.lastMonthRevenue) }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="stat-card warning">
              <div class="stat-item">
                ...
                <div class="stat-content">
                  ...
                  <div class="stat-trend">
                    <span class="trend-text">昨日</span>
                    <span class="trend-value">{{ stats.yesterdaySales }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="stat-card info">
              <div class="stat-item">
                ...
                <div class="stat-content">
                  ...
                  <div class="stat-trend">
                    <span class="trend-text">昨日</span>
                    <span class="trend-value">¥{{ formatCurrency(stats.yesterdayRevenue) }}</span>
                  </div>
                </div>
              </div>
            </div>
