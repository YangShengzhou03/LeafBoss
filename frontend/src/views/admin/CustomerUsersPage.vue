        ...
        <div class="table-container">
          <el-table :data="filteredUsers" style="width: 100%" v-loading="loading" stripe>
            ...
            <el-table-column label="操作" min-width="200" fixed="right" align="center">
              <template #default="scope">
                <el-button size="default" @click="editUser(scope.row)">编辑</el-button>
                <el-button size="default" type="info" @click="resetPassword(scope.row)">重置密码</el-button>
                <el-button size="default" type="danger" @click="deleteUser(scope.row)">删除</el-button>
              </template>
            </el-table-column>
