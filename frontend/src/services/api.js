...
const AdminService = {
  ...
  getProductSalesStats() {
    return Server.get('/api/admin/product-sales-stats')
  },
  ...
  deletePublicReview(id, cardKey) {
    return Server.delete(`/api/public/boss-reviews/${id}`, { cardKey })
  },

  verifyCardKey(cardKey) {
    return Server.get(`/api/card-keys/verify/${cardKey}`)
  }
}
